...
def readingFiles():
    ...
    user_file = open('C:\\Users\\Itsmr\\OneDrive\\Desktop\\Test.txt', 'r')
...
def writingFiles():
    ...
    inFile = open('C:\\Users\\Itsmr\OneDrive\\Desktop\\WriteAFile.txt', 'w')
...
def readEachLine():
    ...
    inFile = open('C:\\Users\\Itsmr\\OneDrive\\Desktop\\Test.txt', 'r')
...
def appendingFiles():
    ...
    inFile = open('C:\\Users\\Itsmr\OneDrive\\Desktop\\WriteAFile.txt', 'a')
...
def strippingLines():
    ...
    inFile = open('C:\\Users\\Itsmr\\OneDrive\\Desktop\\WriteAFile.txt', 'r')
...
def savingNumericData():
    ...
    outFile = open('C:\\Users\\Itsmr\\OneDrive\\Desktop\\Numbers.txt', 'w')
...
def usingNumbersFromFiles():
    ...
    inFile = open('C:\\Users\\Itsmr\\OneDrive\\Desktop\\Numbers.txt', 'r')
...
def usingLoops():
    ...
    outFile = open('C:\\Users\\Itsmr\\OneDrive\\Desktop\\LoopingFiles.txt', 'w')
